(function () {
    ...
    function run () {
      ...
      if(storyboard.encerraJogo())
      {
        ...
        alert("O jogo acabou! Sua pontuação é: ");
      }
    ...
    var storyboard = function()
    {
        ...
        var linhaZeroOcupada =  function(){
          for ( i = 0; i < 10; i++)
          {
             ...
             if(celula.classList.contains("preto"))
             {
                return true;
             }
          }
        ...
        var pintarTabuleiro = function(){
          for (var i = 0; i < storyboard.tabuleiroPreenchido.length; i++) {
              ...
              celula.setAttribute("class","preto" );
          }
        }
    ...
    var peca = function ()
    {
        ...
        var linhaVertical   = ["0-5","1-5","2-5","3-5"]; 
        ...
        var isMovePecaParaBaixo = function()
        {
          ...
          for (var i = 0; i < peca.pecaAtual.length; i++)
          {
              position = peca.getCoodenadaPosicaoX(i) // quebra a posicao em linha e coluna
        ...
        var isMovePecaParaEsquerda = function()
        {
          ...
          for (var i = 0; i < peca.pecaAtual.length; i++)
          {
              position = peca.getCoodenadaPosicaoX(i);
        ...
        var getCoodenadaPosicaoX = function(x)
        {
